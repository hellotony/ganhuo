...
<head>
	...
	<link href="/demo/images/favicon.ico" rel="shortcut icon">
	<link rel="stylesheet" href="/demo/bootstrap/css/bootstrap.css">
	<link rel="stylesheet" href="/demo/main.css">
	<link rel="stylesheet" href="/demo/js/highlight/highlight.css">

	<!--[if lt IE 9]>
      <script src="/demo/js/Respond-1.4.2/respond.min.js"></script>
    <![endif]-->
</head>
<body>
<div class="container">
...
<script type="text/javascript" src="/demo/js/plupload/plupload.full.min.js"></script>
<script type="text/javascript" src="/demo/js/plupload/i18n/zh_CN.js"></script>
<script type="text/javascript" src="/demo/js/ui.js"></script>
<script type="text/javascript" src="/demo/js/qiniu.js"></script>
<script type="text/javascript" src="/demo/js/highlight/highlight.js"></script>
<script type="text/javascript" src="/demo/js/multiple.js"></script>
</body>
</html>
