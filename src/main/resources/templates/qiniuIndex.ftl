...
<head>
    ...
    <link rel="stylesheet" href="/demo/bower_components/bootstrap/dist/css/bootstrap.css">
    <link rel="stylesheet" href="/demo/styles/main.css">
    <link rel="stylesheet" href="/demo/styles/highlight.css">

    <!--[if lt IE 9]>
      <script src="/demo/bower_components/respond/dest/respond.min.js"></script>
    <![endif]-->
</head>
<body>
